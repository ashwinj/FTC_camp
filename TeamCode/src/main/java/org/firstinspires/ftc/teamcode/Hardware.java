...
public class Hardware {
    ...
    public void initializeHardware(HardwareMap hwMap) {
        ...
        encoders = hwMap.dcMotor.get("encoder");
        ...
        encoders.setDirection(DcMotorEx.Direction.FORWARD);
        ...
        if(encoder) {
            ...
            encoders.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        parameters2.loggingEnabled = true; //will log values if true
