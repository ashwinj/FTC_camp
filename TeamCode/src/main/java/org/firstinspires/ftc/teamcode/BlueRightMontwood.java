...
@Disabled
@Autonomous(name = "BlueRightMontwood", group = "Taus")
public class BlueRightMontwood extends AutonomousMethods {
...
//                forward(.5, 0, 12);
            ...
            case 4:
                ...
                forward(.5, 1, 15);
                shoot(-23, (2264*28)/60.0);
                toAngle(90, 1);
                setIntakePower(1);
                backward(1, 0, 7, 6, 2, 0);
                forward(1, 0, 7);
                shoot(-24, (2265*28)/60.0);
                setShooterPower((2195*28)/60.0);
                toAngle(90, 1);
                setIntakePower(1);
                backward(.1, 0, 8);
                backward(.05, 0, 10);
